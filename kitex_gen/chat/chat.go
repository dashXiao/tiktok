...
func NewMessagePostResponse() *MessagePostResponse {
	return &MessagePostResponse{}
}

func (p *MessagePostResponse) InitDefault() {
}

var MessagePostResponse_Base_DEFAULT *BaseResp

func (p *MessagePostResponse) GetBase() (v *BaseResp) {
	if !p.IsSetBase() {
		return MessagePostResponse_Base_DEFAULT
	}
	return p.Base
}
func (p *MessagePostResponse) SetBase(val *BaseResp) {
	p.Base = val
}

var fieldIDToName_MessagePostResponse = map[int16]string{
	1: "base",
}

func (p *MessagePostResponse) IsSetBase() bool {
	return p.Base != nil
}

func (p *MessagePostResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MessagePostResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MessagePostResponse) ReadField1(iprot thrift.TProtocol) error {
	_field := NewBaseResp()
...
func (p *MessagePostResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MessagePostResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MessagePostResponse) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *MessagePostResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("MessagePostResponse(%+v)", *p)

}

func (p *MessagePostResponse) DeepEqual(ano *MessagePostResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MessagePostResponse) Field1DeepEqual(src *BaseResp) bool {
...
type MessageService interface {
	MessagePost(ctx context.Context, req *MessagePostRequest) (r *MessagePostResponse, err error)
...
func (p *MessageServiceClient) MessagePost(ctx context.Context, req *MessagePostRequest) (r *MessagePostResponse, err error) {
...
func (p *messageServiceProcessorMessagePost) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *MessagePostResponse
...
type MessageServiceMessagePostResult struct {
	Success *MessagePostResponse `thrift:"success,0,optional" frugal:"0,optional,MessagePostResponse" json:"success,omitempty"`
}
...
var MessageServiceMessagePostResult_Success_DEFAULT *MessagePostResponse

func (p *MessageServiceMessagePostResult) GetSuccess() (v *MessagePostResponse) {
	if !p.IsSetSuccess() {
...
func (p *MessageServiceMessagePostResult) SetSuccess(x interface{}) {
	p.Success = x.(*MessagePostResponse)
}
...
func (p *MessageServiceMessagePostResult) Field0DeepEqual(src *MessagePostResponse) bool {
