...
type Video struct {
	...
	UploadTime    int64      `thrift:"upload_time,9,required" frugal:"9,required,i64" json:"upload_time"`
}
...
func (p *Video) writeField9(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("upload_time", thrift.I64, 9); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *InteractionServiceVideoFavoritedCountArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewVideoFavoritedCountRequest()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *InteractionServiceVideoFavoritedCountResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewVideoFavoritedCountResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
...
func (p *InteractionServiceUserTotalFavoritedArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewUserTotalFavoritedRequest()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *InteractionServiceUserTotalFavoritedResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewUserTotalFavoritedResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
...
func (p *InteractionServiceCommentCountResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewCommentCountResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
